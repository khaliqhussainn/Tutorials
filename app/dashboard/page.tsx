...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    console.log("Dashboard: Session:", session ? { id: session.user?.id, email: session.user?.email } : null)
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const [statsResponse, coursesResponse, favoritesResponse] = await Promise.allSettled([
      ...
      if (statsResponse.status === 'fulfilled' && statsResponse.value.ok) {
        ...
        console.error("Dashboard: Stats fetch failed:", 
          statsResponse.status === 'fulfilled' ? statsResponse.value.status : statsResponse.reason)
      }
      ...
      if (coursesResponse.status === 'fulfilled' && coursesResponse.value.ok) {
        ...
        console.error("Dashboard: Courses fetch failed:", 
          coursesResponse.status === 'fulfilled' ? coursesResponse.value.status : coursesResponse.reason)
      }
      ...
      if (favoritesResponse.status === 'fulfilled' && favoritesResponse.value.ok) {
        ...
        console.error("Dashboard: Favorites fetch failed:", 
          favoritesResponse.status === 'fulfilled' ? favoritesResponse.value.status : favoritesResponse.reason)
      }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-blue-600 text-lg font-medium">
            {status === 'loading' ? 'Verifying authentication...' : 'Loading your dashboard...'}
          </p>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/auth/signin?callbackUrl=/dashboard')}>
            Sign In
          </Button>
        </div>
      </div>
            ...
            <>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.favoriteCoursesCount}</p>
            ...
            <Card className="border-2 border-dashed border-gray-200 hover:border-gray-300 transition-colors">
              <CardContent className="text-center py-16">
                ...
                <p className="text-gray-500 mb-8 max-w-md mx-auto">
                  You haven't enrolled in any courses yet. Browse our comprehensive catalog to discover amazing learning opportunities.
                </p>
                <div className="flex gap-4 justify-center">
                  <Link href="/courses">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Schedule Learning</h3>
              <p className="text-gray-600 text-sm mb-4">Set up a consistent learning schedule</p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">Define your learning objectives</p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">Track your learning analytics</p>
