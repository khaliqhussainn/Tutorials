      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          >
            ...
            <span className="font-medium">Back to Video</span>
          </Link>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Test your knowledge with {video.tests.length} questions
          </p>
        </div>
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                <div className="font-medium">
                                  Score: {attempt.score}% {attempt.passed && <CheckCircle className="inline w-4 h-4 text-green-600 ml-1" />}
                                </div>
                ...
                {results.passed ? (
                  <div className="space-y-4">
                    <p className="text-green-600 text-lg">
                      Excellent work! You've successfully completed this quiz and can now move on to the next video.
                    </p>
                  ...
                  <div className="space-y-4">
                    <p className="text-red-600 text-lg">
                      You need at least 70% to pass. Review the video content and try again when you're ready.
                    </p>
                    <div className="flex items-center justify-center space-x-4">
                      <Button 
                        size="lg" 
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {!isCorrect && (
                            <div className="flex items-center text-green-700">
                              ...
                              <span className="ml-2">{question.options[question.correct]}</span>
                            </div>
                          )}
                        </div>
                      </div>
